...
#
# Description:
#			This script is an illustration of the main steps during identification of the
...
###############################################
#
# Input Data files (saved in Data folder):
#
# 1. human reference genome GRCh37
# wget ftp://ftp.1000genomes.ebi.ac.uk/vol1/ftp/technical/reference/phase2_reference_assembly_sequence/hs37d5.fa.gz
#
# 2. List of CFTR mutations provided by https://www.cftr2.org/
# https://www.cftr2.org/sites/default/files/CFTR2_8December2017_2.xlsx
# saved as CFTR2_list.csv
#
# 3. Chromosome 7 variants from 1000 Genomes project (VCF)
...
#
# 4. .tbi Index file for Chromosome 7 vcf
...
### The starting point of the analysis is BAM alignment 
# generated by aligning HG00121 whole genome sequence data to human reference genome
# using BWA aligner. The exact steps of generating the alignment can be found here:
# ftp://ftp.1000genomes.ebi.ac.uk/vol1/ftp/historical_data/former_toplevel/README.alignment_data.md 
# As these steps are standard procedure for generating BAM files, I do not repeat them here and 
# start the analysis with the available BAM file.


#Extract low coverage alignment for CFTR region: 117105838-117356025(GRCh37 )
